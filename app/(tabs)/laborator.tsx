  ...
  return (
    <ReactNative.TouchableOpacity
      ...
      style={{
        ...
        borderWidth: 1,
        borderColor: active ? 'rgba(43,140,246,0.6)' : 'rgba(255,255,255,0.08)'
      }}
    >
      <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>{label}</ReactNative.Text>
    </ReactNative.TouchableOpacity>
  )
}
    ...
    <ReactNative.View style={{ flex: 1, backgroundColor: BG }}>
      ...
      <ReactNative.ScrollView contentContainerStyle={{ paddingBottom: 32 }}>
        <ReactNative.View style={{ paddingHorizontal: 20, paddingTop: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <ReactNative.Text style={{ color: '#f6f8ff', fontSize: 26, fontWeight: '800' }}>Fractal Lab</ReactNative.Text>
          <ReactNative.View style={{ flexDirection: 'row', gap: 12 }}>
            <ReactNative.TouchableOpacity style={{ padding: 8 }}>
              <ReactNative.Text style={{ color: '#f6f8ff' }}>===</ReactNative.Text>
            </ReactNative.TouchableOpacity>
            <ReactNative.TouchableOpacity style={{ padding: 8 }}>
              <ReactNative.Text style={{ color: '#f6f8ff' }}>{'->'}</ReactNative.Text>
            </ReactNative.TouchableOpacity>
        ...
        <ReactNative.View style={{ alignItems: 'center', marginTop: 24 }}>
          <ReactNative.View
            style={{
              ...
              borderWidth: 1,
              borderColor: 'rgba(43,140,246,0.6)',
              alignItems: 'center',
          ...
          <ReactNative.Text style={{ color: '#f6f8ff', fontSize: 20, fontWeight: '800', marginTop: 18 }}>Fractal Lab</ReactNative.Text>
          <ReactNative.Text style={{ color: 'rgba(255,255,255,0.7)', textAlign: 'center', marginTop: 6 }}>
        ...
        >
          ...
          <ReactNative.View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            <ReactNative.Text style={{ color: '#f6f8ff', fontSize: 18, fontWeight: '800' }}>Settings</ReactNative.Text>
            <ReactNative.TouchableOpacity style={{ padding: 8 }}>
              <ReactNative.Text style={{ color: 'rgba(255,255,255,0.7)' }}>i</ReactNative.Text>
            </ReactNative.TouchableOpacity>
          </ReactNative.View>
          ...
          <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700', marginBottom: 4 }}>
          ...
          <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700', marginTop: 6, marginBottom: 8 }}>Animation speed</ReactNative.Text>
          ...
          <ReactNative.View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
            <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>Performance mode</ReactNative.Text>
            <ReactNative.TouchableOpacity
              ...
              style={{
                ...
                borderWidth: 1,
                borderColor: performanceMode ? 'rgba(43,140,246,0.6)' : 'rgba(255,255,255,0.08)'
              }}
            >
              <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>{performanceMode ? 'On' : 'Off'}</ReactNative.Text>
            </ReactNative.TouchableOpacity>
          </ReactNative.View>
          ...
          >
            <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '800', fontSize: 16 }}>Generate</ReactNative.Text>
          </ReactNative.TouchableOpacity>
