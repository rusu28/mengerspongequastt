...
const PROPERTY_SECTIONS = [
  ...
  },
  {
    ...
    points: [
      ...
      'Holes H=7*20^(n-1), total H_tot=7*(20^n-1)/19, density ρ=(20/27)^n',
      'Optics: I_out=I_in/(1+kA), T=e^(-μL_opt), reflections ≈3^n',
      'Acoustics: α∝3^n, L_eff≈L_0*3^n, f_n=f_0*3^n',
      'Thermal: k_eff=k_0*(20/27)^n, Q∝A(n), R_th∝1/A(n)',
      'Electrical: R_eff∝(3/20)^n, C∝A(n), f_res=f_0*3^n',
      'Fluids: φ=1-(20/27)^n, R_f∝3^n, A_wet=A(n)'
    ]
  }
]
...
export default function EnergyLab() {
  ...
  return (
    <ReactNative.View style={{ flex: 1, backgroundColor: BG }}>
      ...
      >
        <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>
        ...
        {(['throw', 'grab', 'camera'] as ControlMode[]).map((m) => (
          <ReactNative.TouchableOpacity
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor: controlMode === m ? 'rgba(43,140,246,0.6)' : 'rgba(255,255,255,0.08)'
            }}
          >
            <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>{m === 'throw' ? 'Throw' : m === 'grab' ? 'Lift' : 'Camera'}</ReactNative.Text>
          </ReactNative.TouchableOpacity>
        ))}
      </ReactNative.View>
      ...
      <ReactNative.View style={{ position: 'absolute', left: 12, bottom: panelVisible ? PANEL_MAX_HEIGHT + 20 : 40, flexDirection: 'column', gap: 6 }}>
        <ReactNative.View style={{ flexDirection: 'row', gap: 6 }}>
          <ReactNative.TouchableOpacity
            ...
            style={{ paddingHorizontal: 12, paddingVertical: 10, borderRadius: 8, backgroundColor: 'rgba(0,0,0,0.35)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' }}
          >
            <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>W</ReactNative.Text>
          </ReactNative.TouchableOpacity>
        </ReactNative.View>
        <ReactNative.View style={{ flexDirection: 'row', gap: 6 }}>
          <ReactNative.TouchableOpacity
            ...
            style={{ paddingHorizontal: 12, paddingVertical: 10, borderRadius: 8, backgroundColor: 'rgba(0,0,0,0.35)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' }}
          >
            <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>A</ReactNative.Text>
          </ReactNative.TouchableOpacity>
          <ReactNative.TouchableOpacity
            onPress={() => setCamOffset((c) => ({ ...c, z: c.z + 0.4 }))}
            style={{ paddingHorizontal: 12, paddingVertical: 10, borderRadius: 8, backgroundColor: 'rgba(0,0,0,0.35)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' }}
          >
            <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>S</ReactNative.Text>
          </ReactNative.TouchableOpacity>
          <ReactNative.TouchableOpacity
            onPress={() => setCamOffset((c) => ({ ...c, x: c.x + 0.4 }))}
            style={{ paddingHorizontal: 12, paddingVertical: 10, borderRadius: 8, backgroundColor: 'rgba(0,0,0,0.35)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' }}
          >
            <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>D</ReactNative.Text>
          </ReactNative.TouchableOpacity>
        </ReactNative.View>
      </ReactNative.View>
      ...
      >
        <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>{panelVisible ? 'Hide UI' : 'Show UI'}</ReactNative.Text>
      </ReactNative.TouchableOpacity>
        ...
        >
          ...
          >
            <ReactNative.View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
              <ReactNative.Text style={{ color: '#f6f8ff', fontSize: 15, fontWeight: '800' }}>Energy control</ReactNative.Text>
            ...
            <ReactNative.Text style={{ color: 'rgba(255,255,255,0.78)', marginBottom: 8, fontSize: 12, lineHeight: 18 }}>
            ...
            <ReactNative.View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 }}>
              <ReactNative.TouchableOpacity
                ...
                style={{
                  ...
                  borderWidth: 1,
                  borderColor: animateTime ? 'rgba(43,140,246,0.6)' : 'rgba(255,255,255,0.08)'
                }}
              >
                <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>{animateTime ? 'Time animation ON' : 'Time animation OFF'}</ReactNative.Text>
              </ReactNative.TouchableOpacity>
              <ReactNative.TouchableOpacity
                ...
                style={{
                  ...
                  borderWidth: 1,
                  borderColor: paused ? 'rgba(255,180,92,0.6)' : 'rgba(255,255,255,0.08)'
                }}
              >
                <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700' }}>{paused ? 'Paused' : 'Running'}</ReactNative.Text>
              </ReactNative.TouchableOpacity>
            </ReactNative.View>
            <ReactNative.View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 }}>
              <ReactNative.View>
                <ReactNative.Text style={{ color: '#8fd4ff', fontWeight: '700', fontSize: 13 }}>Kinetic energy</ReactNative.Text>
                <ReactNative.Text style={{ color: '#f6f8ff', fontSize: 13 }}>{kinetic.toFixed(2)} J</ReactNative.Text>
              </ReactNative.View>
              <ReactNative.View>
                <ReactNative.Text style={{ color: '#8fd4ff', fontWeight: '700', fontSize: 13 }}>Potential energy</ReactNative.Text>
                <ReactNative.Text style={{ color: '#f6f8ff', fontSize: 13 }}>{potential.toFixed(2)} J</ReactNative.Text>
              </ReactNative.View>
              <ReactNative.View>
                <ReactNative.Text style={{ color: '#8fd4ff', fontWeight: '700', fontSize: 13 }}>Total</ReactNative.Text>
                <ReactNative.Text style={{ color: '#f6f8ff', fontSize: 13 }}>{total.toFixed(2)} J</ReactNative.Text>
              </ReactNative.View>
            </ReactNative.View>

            <ReactNative.View style={{ marginTop: 12 }}>
              <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '800', fontSize: 14, marginBottom: 8 }}>Fractal physical properties</ReactNative.Text>
                  ...
                  return (
                    <ReactNative.TouchableOpacity
                      ...
                      style={{
                        ...
                        borderWidth: 1,
                        borderColor: active ? 'rgba(43,140,246,0.65)' : 'rgba(255,255,255,0.08)'
                      }}
                    >
                      <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '700', fontSize: 12 }}>{section.title}</ReactNative.Text>
                    </ReactNative.TouchableOpacity>
                  )
                })}
              </ReactNative.View>
              ...
              {(() => {
                ...
                return (
                  <ReactNative.View style={{ marginTop: 10, padding: 12, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.04)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' }}>
                    {active.points.map((pt) => (
                      <ReactNative.Text key={pt} style={{ color: 'rgba(255,255,255,0.82)', marginBottom: 4, fontSize: 12 }}>
                        ? {pt}
                      </ReactNative.Text>
                    ))}
                  </ReactNative.View>
            ...
            <ReactNative.View style={{ marginTop: 12 }}>
              <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '800', fontSize: 14, marginBottom: 6 }}>Tuning constants (live)</ReactNative.Text>
              <ReactNative.View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
                {[
                  { label: 'L₀ (m) — base optical path', value: baseL0.toString(), setter: (v: string) => setBaseL0(parseNumber(v, baseL0)), note: 'Base optical path length', use: 'Used in L_opt and T(n)' },
                  { label: 'μ (1/m) — attenuation', value: baseMu.toString(), setter: (v: string) => setBaseMu(parseNumber(v, baseMu)), note: 'Attenuation coefficient', use: 'Used in T(n)=e^(-μ·L_opt)' },
                  ...
                  { label: 'I₀ — input intensity', value: baseI0.toString(), setter: (v: string) => setBaseI0(parseNumber(v, baseI0)), note: 'Input intensity', use: 'Used in scattered intensity' },
                  { label: 'f₀ (Hz) — base resonance', value: baseF0.toString(), setter: (v: string) => setBaseF0(parseNumber(v, baseF0)), note: 'Base resonant frequency', use: 'Used in f_n = f₀·3^n' },
                  { label: 'k₀ (W/mK) — thermal base', value: baseK0.toString(), setter: (v: string) => setBaseK0(parseNumber(v, baseK0)), note: 'Base thermal conductivity', use: 'Used in k_eff, heat flux Φ' },
                  { label: 'R₀ (Ω) — electrical base', value: baseR.toString(), setter: (v: string) => setBaseR(parseNumber(v, baseR)), note: 'Base electrical resistance', use: 'Used in R_eff scaling' },
                  { label: 'ΔT (K) — temperature gradient', value: baseDeltaT.toString(), setter: (v: string) => setBaseDeltaT(parseNumber(v, baseDeltaT)), note: 'Temperature gradient', use: 'Used in heat flux Φ' }
                ].map(({ label, value, setter, note, use }) => (
                  <ReactNative.View key={label} style={{ width: '48%' }}>
                    <ReactNative.Text style={{ color: 'rgba(255,255,255,0.75)', fontSize: 12 }}>{label}</ReactNative.Text>
                    ...
                    />
                    <ReactNative.Text style={{ color: 'rgba(255,255,255,0.55)', fontSize: 11, marginTop: 2 }}>{note}</ReactNative.Text>
                    <ReactNative.Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11 }}>{use}</ReactNative.Text>
                  </ReactNative.View>
                ))}
              </ReactNative.View>
            </ReactNative.View>
            ...
            <ReactNative.View style={{ marginTop: 12 }}>
              <ReactNative.Text style={{ color: '#f6f8ff', fontWeight: '800', fontSize: 14, marginBottom: 6 }}>Formula values (n = {formulas.n})</ReactNative.Text>
              <ReactNative.View style={{ backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', padding: 12 }}>
                {[
                  ...
                  ['Density ρ', formatNumber(formulas.density)],
                  ...
                  ['Acoustics: α ~3^n', formatNumber(formulas.acousticsAlpha)],
                  ...
                  ['Fluid porosity φ', formatNumber(formulas.fluidPorosity)],
                  ...
                  ['Heat flux Φ', formatNumber(formulas.heatFlux)]
                ].map(([label, value]) => (
                  <ReactNative.View key={label} style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 }}>
                    <ReactNative.Text style={{ color: 'rgba(255,255,255,0.78)', fontSize: 12 }}>{label}</ReactNative.Text>
                    <ReactNative.Text style={{ color: '#f6f8ff', fontSize: 12, fontWeight: '700' }}>{value}</ReactNative.Text>
                  </ReactNative.View>
                ))}
              </ReactNative.View>
            </ReactNative.View>
