...
function MiniTutorial({ visible, onClose }) {
  ...
  return (
    <ReactNative.View style={{
      ...
      <ReactNative.Text style={{ fontWeight: '800', fontSize: 18, marginBottom: 8, color: '#f2f6ff' }}>Menger Sponge - quick guide</ReactNative.Text>
      <ReactNative.Text style={{ color: '#d5ddee', marginBottom: 4 }}>- Fractal built recursively from 3x3x3 subdivisions.</ReactNative.Text>
      <ReactNative.Text style={{ color: '#d5ddee', marginBottom: 4 }}>- Remove the center cube and all face centers at every level.</ReactNative.Text>
      <ReactNative.Text style={{ color: '#d5ddee', marginBottom: 4 }}>- Cube count explodes: 1 -> 7 -> 147 -> 2947 -> 58947.</ReactNative.Text>
      <ReactNative.Text style={{ color: '#d5ddee' }}>- On mobile you can tilt the phone to rotate the model.</ReactNative.Text>

      <ReactNative.TouchableOpacity onPress={onClose} style={{ marginTop: 14, padding: 10, backgroundColor: '#2b8cf6', borderRadius: 10, alignSelf: 'flex-end' }}>
        <ReactNative.Text style={{ color: '#f2f6ff', fontWeight: '600' }}>Got it</ReactNative.Text>
...
export default function App() {
  ...
  return (
    <ReactNative.View style={{ flex: 1, backgroundColor: '#08131d' }}>
      <Canvas
        style={{ flex: 1 }}
        camera={{ position: mobile ? [2.6, 2.6, 2.6] : [2, 2, 2], fov: mobile ? 60 : 50 }}
      >
        <color attach="background" args={['#0b1621']} />
      ...
      <ReactNative.View style={{
        ...
        <ReactNative.View>
          <ReactNative.Text style={{ color: '#f2f6ff', fontSize: mobile ? 22 : 20, fontWeight: '800', letterSpacing: 0.3 }}>Menger Sponge Viewer</ReactNative.Text>
          <ReactNative.Text style={{ color: 'rgba(255,255,255,0.7)', marginTop: 4 }}>Explore the fractal in 3D</ReactNative.Text>
        </ReactNative.View>
        <ReactNative.TouchableOpacity
      ...
      <ReactNative.View style={{
        ...
        left: 16,
        right: 16,
        backgroundColor: 'rgba(6,12,20,0.82)',
        borderRadius: 20,
        padding: 16,
        borderWidth: 1,
        ...
        <ReactNative.View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
          <ReactNative.Text style={{ color: '#f2f6ff', fontSize: 18, fontWeight: '700' }}>Iteration level</ReactNative.Text>
        ...
        <ReactNative.View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 8 }}>
          <ReactNative.TouchableOpacity
            ...
            style={{
              ...
              paddingVertical: 8,
              borderRadius: 999,
              backgroundColor: lowGraphics ? 'rgba(43,140,246,0.18)' : 'rgba(255,255,255,0.08)',
              borderWidth: 1,
              borderColor: lowGraphics ? 'rgba(43,140,246,0.55)' : 'rgba(255,255,255,0.12)'
            }}
          >
            <ReactNative.Text style={{ color: '#f2f6ff', fontWeight: '600' }}>{lowGraphics ? 'Low Graphics ON' : 'High Fidelity'}</ReactNative.Text>
          </ReactNative.TouchableOpacity>
          <ReactNative.Text style={{ color: 'rgba(255,255,255,0.75)', marginLeft: 10 }}>
        ...
        <ReactNative.View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 12 }}>
          <ReactNative.View>
            <ReactNative.Text style={{ color: 'rgba(255,255,255,0.6)', fontSize: 12 }}>Cubes</ReactNative.Text>
            <ReactNative.Text style={{ color: '#f2f6ff', fontWeight: '700', marginTop: 2 }}>{cubeCount}</ReactNative.Text>
          </ReactNative.View>
          <ReactNative.View>
            <ReactNative.Text style={{ color: 'rgba(255,255,255,0.6)', fontSize: 12 }}>Cube size</ReactNative.Text>
            <ReactNative.Text style={{ color: '#f2f6ff', fontWeight: '700', marginTop: 2 }}>{cubeSizeDisplay}</ReactNative.Text>
          </ReactNative.View>
          <ReactNative.View>
            <ReactNative.Text style={{ color: 'rgba(255,255,255,0.6)', fontSize: 12 }}>Quality</ReactNative.Text>
            <ReactNative.Text style={{ color: '#f2f6ff', fontWeight: '700', marginTop: 2 }}>{lowGraphics ? 'Performance' : 'Detail'}</ReactNative.Text>
          </ReactNative.View>
        </ReactNative.View>

        {performanceNotice ? (
          <ReactNative.Text style={{ marginTop: 10, color: 'rgba(255,255,255,0.65)', fontSize: 12 }}>
